function showFicheiro(f){
    if(f.mimetype == 'image/png')
        var ficheiro = $('<img src="/ficheiro/'+ f.name+ '" width="80%"/>')
    else
...
$(function(){
    ...
    $("#mais1").click(e=>{
        ...
        var descLabel = $('<label class ="w3-cell">Descricao:</label')
        ...
        var ficheiroInput = $('<input/>', {class: 'w3-input w3-cell', type: "text", name: "ficheiro"})
